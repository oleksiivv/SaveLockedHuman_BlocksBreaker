...
public class SkinsController : MonoBehaviour
{
    ...
    void Start(){
        ...
        items.Add(new ShopItem(1,100,"City"));
        items.Add(new ShopItem(2,200,"Dungeon"));
        items.Add(new ShopItem(3,250,"Village"));
        items.Add(new ShopItem(4,350,"Forest"));
        items.Add(new ShopItem(5,500,"Desert"));
